...
class GoogleNewTransError(Exception):
    ...
    def __init__(self, msg=None, **kwargs):
        ...
        if msg:
            ...
            self.msg = None
        super(GoogleNewTransError, self).__init__(self.msg)
...
class GoogleTranslator:
    ...
    def translate(self, text, lang_tgt='auto', lang_src='auto', pronounce=False):
        ...
        freq = _package_rpc(text, lang_src, lang_tgt)
        ...
        try:
            ...
            raise GoogleNewTransError(tts=self, response=r)
        except requests.exceptions.RequestException as e:
            # Request failed
            raise GoogleNewTransError(tts=self)
